...
general = {
    ...
    scripts = "",
    refman = "manual_1.30/refman/enigma-ref.pdf",
    manual = "manual_1.30/manual/enigma.html",
...
html.statistics = {
    ...
    average_percent_de = "Durchschnitt %",
    average_percent_ru = "В среднем %",
    average_percent_es = "Promedio %",
    count = "count",
    count_de = "Anzahl",
    count_ru = "Оценено",
    count_es = "Cuenta",
    count_percent = "count %",
    count_percent_de = "Anzahl %",
    count_percent_ru = "Оценено %",
    count_percent_es = "Cuenta %",
    user = "user",
    user_de = "Spieler",
    ...
    difficult_percent = "difficult %",
    difficult_percent_de = "schwer %",
    difficult_percent_ru = "Сложные %",
    difficult_percent_es = "Dificultad %",
    easy = "easy",
    easy_de = "leicht",
    easy_ru = "Простые",
    easy_es = "F&aacute;cil",
    easy_percent = "easy %",
    easy_percent_de = "leicht %",
    easy_percent_ru = "Простые %",
    easy_percent_es = "F&aacute;cil %",
    total = "total",
    total_de = "gesamt",
    total_ru = "Всего",
    total_es = "total",
...
-- removed entry "table-hcp" in body because of to few scores
